...
parser.add_argument('--kinetics_path',type=str,default='../datas/cscc/pretrain/k400/')
parser.add_argument('--data_path',type=str,default='/l/users/ganzorig.batnasan/data/kinetics-dataset/k400/')
