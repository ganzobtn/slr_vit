...
OUTPUT_DIR='/projects/results/videomaev2/finetune/24.02.16/wlasl_1518/vit_b_32_wlasl_1518_ft_from_asl_32/0'
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES="6,7" python -m torch.distributed.launch --nproc_per_node=${GPUS_PER_NODE} \
