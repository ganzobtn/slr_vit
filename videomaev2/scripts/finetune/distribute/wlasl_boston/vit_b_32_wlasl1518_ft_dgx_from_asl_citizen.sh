...
OUTPUT_DIR='/projects/results/videomaev2/finetune/24.02.16/wlasl_1518/vit_b_32_wlasl_1518_ft_from_asl/0'
...
MODEL_PATH='/projects/results/videomaev2/finetune/24.02.23/aslcitizen_2731/vit_b_aslcitizen_2731_ft/0/checkpoint-best/mp_rank_00_model_states.pt'
N_NODES=1
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES="0,3" python -m torch.distributed.launch --nproc_per_node=${GPUS_PER_NODE} \
