...
OUTPUT_DIR='/projects/results/videomaev2/finetune/24.05.08/aslcitizen_2731/vit_b_16_asl_citizen_ft_from_wlasl_2000/0'

DATA_PATH='/projects/videomaev2/datas/dgx/finetune/revised/24.02.23/aslcitizen_2731'
MODEL_PATH='/projects/results/videomaev2/finetune/vit_b_wlasl_2000_ft/0/checkpoint-best/mp_rank_00_model_states.pt'
