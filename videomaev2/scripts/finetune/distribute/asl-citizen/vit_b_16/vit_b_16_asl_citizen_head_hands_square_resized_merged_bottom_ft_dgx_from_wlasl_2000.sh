...
OUTPUT_DIR='/projects/results/videomaev2/finetune/24.06.05/aslcitizen_2731/vit_b_16_asl_citizen_head_hands_square_resized_merged_bottom_ft_from_wlasl_2000/0'
...
MODEL_PATH='/projects/results/videomaev2/finetune/others/vit_b_wlasl_2000_ft/0/checkpoint-best/mp_rank_00_model_states.pt'
