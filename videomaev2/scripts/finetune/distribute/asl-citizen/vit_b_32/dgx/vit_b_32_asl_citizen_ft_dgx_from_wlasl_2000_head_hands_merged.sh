...
OUTPUT_DIR='/projects/results/videomaev2/finetune/24.05.08/aslcitizen_2731/vit_b_32_asl_citizen_ft_from_wlasl_2000_head_hands_merged/0'

DATA_PATH='/projects/videomaev2/datas/dgx/finetune/revised/24.02.23/aslcitizen_2731'
MODEL_PATH='/projects/results/videomaev2/finetune/24.05.03/wlasl_2000/vit_b_32_wlasl_2000_head_hands_merged_ft/0/checkpoint-best/mp_rank_00_model_states.pt'
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES="0,1,2,3,4,5,6,7" python -m torch.distributed.launch --nproc_per_node=${GPUS_PER_NODE} \
        ...
        --test_num_segment 2 \
        --test_num_crop 2 \
        --resume /projects/results/videomaev2/finetune/24.05.08/aslcitizen_2731/vit_b_32_asl_citizen_ft_from_wlasl_2000_head_hands_merged/0/checkpoint-29/mp_rank_00_model_states.pt \
        --auto_resume \
