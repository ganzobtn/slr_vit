...
OUTPUT_DIR='/projects/results/videomaev2/finetune/24.05.16/aslcitizen_2731/vit_b_32_asl_citizen_head_hands_square_resized_merged_ft_from_wlasl_2000_original/0'
...
MODEL_PATH='/projects/results/videomaev2/finetune/24.05.03/wlasl_2000/vit_b_32_wlasl_2000_ft/0/checkpoint-best/mp_rank_00_model_states.pt'
