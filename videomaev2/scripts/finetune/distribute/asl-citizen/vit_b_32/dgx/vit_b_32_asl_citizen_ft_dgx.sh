...
OUTPUT_DIR='/projects/results/videomaev2/finetune/24.02.23/aslcitizen_2731/vit_b_32_asl_citizen_ft/0'
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES="0,3,4,5" python -m torch.distributed.launch --nproc_per_node=${GPUS_PER_NODE} \
