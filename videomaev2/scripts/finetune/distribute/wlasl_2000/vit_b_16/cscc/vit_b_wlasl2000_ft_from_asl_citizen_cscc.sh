...
OUTPUT_DIR='/l/users/ganzorig.batnasan/results/videomaev2/finetune/vit_b_32_wlasl_2000_from_asl_citizen_ft/0'

DATA_PATH='/home/ganzorig.batnasan/videomaev2/datas/cscc/finetune/revised/wlasl_2000/'
#MODEL_PATH='/l/users/ganzorig.batnasan/libraries/pretrained_models/videomaev2/vit_b_k710_dl_from_giant.pth'
MODEL_PATH='/l/users/ganzorig.batnasan/results/videomaev2/finetune/vit_b_32_asl_citizen_ft/0/checkpoint-best.pth'
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES="0,1,2,3" torchrun --nproc_per_node=${GPUS_PER_NODE} \
