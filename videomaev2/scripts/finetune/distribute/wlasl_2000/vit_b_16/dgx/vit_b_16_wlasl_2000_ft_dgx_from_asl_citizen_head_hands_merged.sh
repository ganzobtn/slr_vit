...
OUTPUT_DIR='/projects/results/videomaev2/finetune/24.05.15/wlasl_2000/vit_b_16_wlasl_2000_from_asl_citizen_head_hands_merged/0'
...
MODEL_PATH='/projects/results/videomaev2/finetune/24.04.27/aslcitizen_2731/vit_b_16_asl_citizen_head_hands_merged_resized_ft/0/checkpoint-best/mp_rank_00_model_states.pt'
