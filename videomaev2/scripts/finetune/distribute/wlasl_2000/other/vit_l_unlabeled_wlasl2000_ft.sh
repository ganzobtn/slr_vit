...
OUTPUT_DIR='/projects/results/videomaev2/finetune/vit_l_unlabeled_hybrid_pt_800e_k710_ft_wlasl_2000_ft/0'

DATA_PATH='/projects/videomaev2/datas/dgx/finetune/revised/wlasl_2000'
MODEL_PATH='/projects/libraries/pretrained_models/InternVideo/finetune/vit_l_hybrid_pt_800e_k700_ft.pth'
