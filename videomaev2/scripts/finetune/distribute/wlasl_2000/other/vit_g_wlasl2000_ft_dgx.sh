...
OUTPUT_DIR='/projects/results/videomaev2/finetune/vit_g_wlasl_2000_ft/0'

DATA_PATH='/projects/videomaev2/datas/dgx/finetune/revised/wlasl_2000/'
MODEL_PATH='/projects/libraries/pretrained_models/videomaev2/vit_g_hybrid_pt_1200e.pth'
