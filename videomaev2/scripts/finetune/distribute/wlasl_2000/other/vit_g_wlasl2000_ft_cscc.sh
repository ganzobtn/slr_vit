...
OUTPUT_DIR='/l/users/ganzorig.batnasan/results/videomaev2/finetune/vit_g_wlasl_2000_ft/0'

DATA_PATH='datas/cscc/finetune/wlasl_2000/'
MODEL_PATH='/l/users/ganzorig.batnasan/libraries/pretrained_models/videomaev2/vit_g_hybrid_pt_1200e.pth'
