...
OUTPUT_DIR='/projects/results/videomaev2/finetune/24.05.03/wlasl_2000/vit_b_32_wlasl_2000_ft/0'
...
#MODEL_PATH='/projects/results/videomaev2/finetune/24.04.30/wlasl_2000/vit_b_32_wlasl_2000_head_hands_merged_from_asl_citizen_ft_/0/checkpoint-best/mp_rank_00_model_states.pt'
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES="0,1,2,3" torchrun --nnodes=1 --nproc_per_node=${GPUS_PER_NODE} \
        --master_port=12321\
