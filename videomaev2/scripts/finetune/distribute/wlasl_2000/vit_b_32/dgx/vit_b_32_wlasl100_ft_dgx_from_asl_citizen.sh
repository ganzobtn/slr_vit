...
OUTPUT_DIR='/projects/results/videomaev2/finetune/vit_b_32_wlasl_100_ft/0'
...
MODEL_PATH='/projects/results/videomaev2/finetune/vit_b_32_wlasl_100_head_hands_merged_from_asl_citizen_ft/0/checkpoint-best/mp_rank_00_model_states.pt'
N_NODES=1
