...
OUTPUT_DIR='/l/users/ganzorig.batnasan/results/videomaev2/finetune/vit_b_32_wlasl_300_from_asl_citizen_ft/0'
DATA_ROOT='/tmp/data/wlasl_2000/WLASL2000_head_hands_merged'
DATA_PATH='/home/ganzorig.batnasan/videomaev2/datas/dgx/finetune/revised/24.04.27/wlasl_300/'
...
OMP_NUM_THREADS=1 torchrun --nnodes=1 --nproc_per_node=${GPUS_PER_NODE} \
        --node_rank=0 \
        --master_addr=192.168.52.113 --master_port=12321\
