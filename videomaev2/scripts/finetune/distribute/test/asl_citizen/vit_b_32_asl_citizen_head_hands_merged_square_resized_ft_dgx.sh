...
OUTPUT_DIR='/projects/results/videomaev2/finetune/test/aslcitizen_2731/vit_b_32_asl_citizen_head_hands_merged_resized/1'
...
MODEL_PATH='/projects/results/videomaev2/finetune/24.04.29/aslcitizen_2731/vit_b_32_asl_citizen_head_hands_merged_resized_ft/3/checkpoint-best/mp_rank_00_model_states.pt'

# wlasl_videos_path ='/projects/data/asl-citizen/ASL_Citizen/ASLCitizen_head_hands_merged'
# kinetics_path = '/projects/videomaev2/datas/dgx/finetune/revised/24.02.23/aslcitizen_2731_head_hands_merged'
# wlasl_path = '/projects/data/asl-citizen/ASL_Citizen/'
