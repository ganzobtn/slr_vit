...
OUTPUT_DIR='/projects/results/videomaev2/finetune/test/aslcitizen_2731/vit_b_32_asl_citizen_original_head_hands_square_resized_merged_bottom_patch_independent_ft/0'
...
MODEL_PATH='/projects/results/videomaev2/finetune/24.05.27/aslcitizen_2731/vit_b_32_asl_citizen_head_hands_square_resized_merged_bottom_patch_independent_ft/1/checkpoint-best/mp_rank_00_model_states.pt'
