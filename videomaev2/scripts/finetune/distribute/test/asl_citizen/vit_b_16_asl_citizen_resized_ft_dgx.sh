...
OUTPUT_DIR='/projects/results/videomaev2/finetune/test/aslcitizen_2731/vit_b_16_asl_citizen_resized_ft/0'
...
MODEL_PATH='/projects/results/videomaev2/finetune/24.05.28/aslcitizen_2731/vit_b_16_asl_citizen_resized_ft/0/checkpoint-best/mp_rank_00_model_states.pt'
