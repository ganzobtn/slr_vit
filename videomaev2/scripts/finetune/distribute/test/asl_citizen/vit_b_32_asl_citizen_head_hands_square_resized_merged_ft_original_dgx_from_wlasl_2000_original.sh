...
OUTPUT_DIR='/projects/results/videomaev2/finetune/test/aslcitizen_2731/vit_b_32_asl_citizen_head_hands_square_resized_mergd_ft_original_from_wlasl_2000_original/1'
...
MODEL_PATH='/projects/results/videomaev2/finetune/24.05.08/aslcitizen_2731/vit_b_32_asl_citizen_ft_from_wlasl_2000/0/checkpoint-best/mp_rank_00_model_states.pt'
