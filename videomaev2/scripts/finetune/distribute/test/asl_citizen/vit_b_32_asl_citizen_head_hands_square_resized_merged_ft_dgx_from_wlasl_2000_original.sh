...
OUTPUT_DIR='/projects/results/videomaev2/finetune/test/aslcitizen_2731/vit_b_32_asl_citizen_head_hands_square_resized_merged_ft_from_wlasl_2000_original/1'
DATA_ROOT='/projects/data/asl-citizen/ASL_Citizen/ASLCitizen_square_head_hands_merged'
DATA_PATH='/projects/videomaev2/datas/dgx/finetune/revised/24.04.27/aslcitizen_2731'
MODEL_PATH='/projects/results/videomaev2/finetune/24.05.16/aslcitizen_2731/vit_b_32_asl_citizen_head_hands_square_resized_merged_ft_from_wlasl_2000_original/0/checkpoint-best/mp_rank_00_model_states.pt'
