...
OUTPUT_DIR='/projects/results/videomaev2/finetune/test/aslcitizen_2731/vit_b_32_asl_citizen_head_hands_square_resized_merged_bottom_patch_independent_ft/1'
