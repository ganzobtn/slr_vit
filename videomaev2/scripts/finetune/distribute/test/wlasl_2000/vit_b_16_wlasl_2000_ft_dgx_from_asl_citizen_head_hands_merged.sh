...
OUTPUT_DIR='/projects/results/videomaev2/finetune/test/wlasl_2000/vit_b_16_wlasl_2000_from_asl_citizen_head_hands_merged/1'
DATA_PATH='/projects/videomaev2/datas/dgx/finetune/revised/wlasl_2000'
MODEL_PATH='/projects/results/videomaev2/finetune/24.05.15/wlasl_2000/vit_b_16_wlasl_2000_from_asl_citizen_head_hands_merged/0/checkpoint-best/mp_rank_00_model_states.pt'
...
OMP_NUM_THREADS=1 CUDA_VISIBLE_DEVICES="0" torchrun --nnodes=1 --nproc_per_node=${GPUS_PER_NODE} \
        --master_port=12320\
